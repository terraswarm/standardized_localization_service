  ...
  def run(self):
    ...
    while True:
      ...
      if gcl_name == logs[2]:
        ...
        try:
          location = fa.getPositionEstimateEuclidean(wifi_scan[0], self.training_path)  
        except:
          location = None
...
if __name__ == "__main__":
  ...
  provisioning_service_id = 5
  training_files = str('/home/tkn/Desktop/standardized_location_service/benchmark_data/euclidean_semantic/')
